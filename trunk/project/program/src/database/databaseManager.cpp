...
void DatabaseManager::addPositionsToTeams()
{
...
void DatabaseManager::addShiftsToTeams()
{
...
void DatabaseManager::addEmployees()
{
    res = stmt->executeQuery(
        "SELECT ID, name, wage, points, priority, "
...
void DatabaseManager::addTeamsToEmployees()
{
...
void DatabaseManager::addEnemiesToEmployees()
{
...
void DatabaseManager::addPositionToEmployees()
{
...
void DatabaseManager::addShiftsToEmployees()
{
