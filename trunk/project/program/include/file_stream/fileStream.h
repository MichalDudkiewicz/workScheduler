...
/// deprecated method
void
desiredSchedule(const std::string&) noexcept(false);
/// deprecated method
void
teamRepository(const std::string&) noexcept(false);
/// deprecated method
void
teamSchedule(const std::string&) noexcept(false);
/// deprecated method
}
...
/// deprecated method
void
schedule(const std::string&) noexcept(false);
/// deprecated method
void
teamRepository(const std::string&) noexcept(false);
/// deprecated method
...
template<typename T>
std::vector<T>
cellToRawValues(std::string& chain, char separator)
{
  std::vector<T> output;
