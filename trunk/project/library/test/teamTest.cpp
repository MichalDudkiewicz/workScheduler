...
struct FixtureTeamTest {
    ...
    FixtureTeamTest()
        ...
        , tuesday(new Shift(2, 5, 2))
        , wednesday(new Shift(10, 12, 3))
        , thursday(new Shift(0, 7, 4))
        , friday(new Shift(1, 5, 5))
        , saturday(new Shift(8, 16, 6))
    ...
    boost::test_tools::output_test_stream shiftsCopy, shiftsOriginal,
        positionsCopy, positionsOriginal;
    shiftsPtr shifts;
