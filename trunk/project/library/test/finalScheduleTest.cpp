...
BOOST_AUTO_TEST_CASE(FinalScheduleCase)
{
  ...
  EmployeeRepository::getInstance()
    ...
    ->getAvailability()
    .getDesiredSchedule()
    .addShift(4, 11, firstMonday.day());
  EmployeeRepository::getInstance()
    .get(2)
    ->getFactor()
    ->getAvailability()
    .getDesiredSchedule()
    .addShift(9, 16, firstMonday.day() + 1);
  EmployeeRepository::getInstance()
    .get(3)
    ->getFactor()
    ->getAvailability()
  ...
  EmployeeRepository::getInstance()
    ...
    ->getFactor()
    ->getAuthorisation()
    .addTeam(TeamRepository::getInstance().get("S2"));
  EmployeeRepository::getInstance()
    .get(2)
    ->getFactor()
    ->getAuthorisation()
    .addTeam(TeamRepository::getInstance().get("1"));
  EmployeeRepository::getInstance()
    .get(3)
    ->getFactor()
    ->getAuthorisation()
  ...
  BOOST_CHECK_EQUAL(
    schedule.getSchedule()[0]
      ...
      .at(
        TeamRepository::getInstance().getAll().front()->getPositions().front())
      .empty(),
    true);
  BOOST_CHECK_EQUAL(
    schedule.getSchedule()[firstMonday.day() - 1]
    ...
    3);
  BOOST_CHECK_EQUAL(
    schedule.getSchedule()[firstMonday.day()]
