...
BOOST_AUTO_TEST_SUITE(TestSuiteCorrect)
    ...
    struct FixtureEmployeeScheduleTest {
        FixtureEmployeeScheduleTest()
                : s1(), s2(), s3(), s4(), s5(), s6(), shift1(new Shift(5, 10, 3)), shift2(new Shift(15, 20, 3)),
                  shift3(new Shift(5, 10, 15)), shift4(new Shift(5, 15, 11)), shift5(new Shift(4, 15, 11)),
                  shift6(new Shift(20, 24, 11)), schedule() {};
