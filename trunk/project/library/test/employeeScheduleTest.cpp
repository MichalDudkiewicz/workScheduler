...
BOOST_AUTO_TEST_SUITE(TestSuiteCorrect)
    ...
    struct FixtureEmployeeScheduleTest {
        FixtureEmployeeScheduleTest() : s1(), s2(), s3(), s4(), s5(), s6(), shift1(new Shift(5, 10, 3)), shift2(new Shift(15, 20, 3)), shift3(new Shift(5, 10, 15)), shift4(new Shift(5, 15, 11)), shift5(new Shift(4, 15, 11)), shift6(new Shift(20, 24, 11)), schedule() {};
    ...
    BOOST_FIXTURE_TEST_CASE(EmployeeScheduleCaseRemoveShift, FixtureEmployeeScheduleTest)
    {
        s1<<shift1->shiftInfo();
        s2<<shift2->shiftInfo();
        s3<<shift3->shiftInfo();
