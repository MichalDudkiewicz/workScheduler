...
calendar::getStartDate()
{
  ...
  boost::gregorian::date startDate(
    nextMonthDate.year(), nextMonthDate.month(), 1);
  return startDate;
}

std::string
calendar::getWeekDay(unsigned int indeks)
{
...
unsigned int
calendar::getWeekDayIterator(const boost::gregorian::date& d)
{
...
unsigned int
calendar::whatDayOfWeek(unsigned int dayOfMonth)
{
